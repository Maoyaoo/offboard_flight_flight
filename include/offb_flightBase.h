...
namespace AutoFlight
{
	...
	protected:
		...
		geometry_msgs::PoseStamped currPose_; // 无人机当前位置
		geometry_msgs::PoseStamped poseTgt_;  // 无人机目标位置
		...
		bool currPoseReceived_ = false;	   // 无人机位置接收标志位
		bool mavrosStateReceived_ = false; // 无人机状态接收标志位
